...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/geometry/segment_intersection.test.cpp\"\n#define\
    \ PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/2/CGL_2_B\"\
    ...
    \ - a), std::sin(t - a)) * c1.r;\n    return {p1, p2};\n}\n#line 5 \"verify/aoj/geometry/segment_intersection.test.cpp\"\
    \n\nint main() {\n    int q = in();\n    for(int q_ : rep(q)) {\n        point<i64>\
    \ p0 = in(), p1 = in(), p2 = in(), p3 = in();\n        segment<i64> s1(p0, p1),\
  ...
  verifiedWith: []
documentation_of: verify/aoj/geometry/segment_intersection.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/geometry/segment_intersection.test.cpp
- /verify/verify/aoj/geometry/segment_intersection.test.cpp.html

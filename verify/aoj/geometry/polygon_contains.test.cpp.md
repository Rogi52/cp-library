...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/geometry/polygon_contains.test.cpp\"\n#define\
    \ PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/3/CGL_3_C\"\
    ...
    }\n#line 5 \"verify/aoj/geometry/polygon_contains.test.cpp\"\n\nint main() {\n\
    \    int n = in();\n    polygon<i64> g = in(n);\n\n    int q = in();\n    for(int\
    \ q_ : rep(q)) {\n        point<i64> p = in();\n        print(contains(g, p));\n\
    \    }\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/aoj/geometry/polygon_contains.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/geometry/polygon_contains.test.cpp
- /verify/verify/aoj/geometry/polygon_contains.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/geometry/distance_ss.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/2/CGL_2_D\"\n#define\
    ...
    }\n#line 6 \"verify/aoj/geometry/distance_ss.test.cpp\"\n\nint main() {\n    printer::precision(20);\n\
    \    int q = in();\n    for(int q_ : rep(q)) {\n        point<ld> p0 = in(), p1\
  ...
  verifiedWith: []
documentation_of: verify/aoj/geometry/distance_ss.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/geometry/distance_ss.test.cpp
- /verify/verify/aoj/geometry/distance_ss.test.cpp.html

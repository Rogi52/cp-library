...
data:
  ...
  bundledCode: "#line 1 \"verify/library_checker/number/partition.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/partition_function\"\n\n#line 2 \"\
    src/cp-template.hpp\"\n#include <bits/stdc++.h>\nusing namespace std;\nusing ll\
    ...
    #line 6 \"verify/library_checker/number/partition.test.cpp\"\n\nint main() {\n\
...
layout: document
redirect_from:
- /verify/verify/library_checker/number/partition.test.cpp
- /verify/verify/library_checker/number/partition.test.cpp.html

...
data:
  ...
  bundledCode: "#line 1 \"verify/library_checker/graph/tree/jump_on_tree.test.cpp\"\
    ...
    \ 5 \"verify/library_checker/graph/tree/jump_on_tree.test.cpp\"\n\nint main()\
    \ {\n    int N = in(), Q = in();\n    tree_graph<int> g(N);\n    for(int _ : rep(N\
    \ - 1)) {\n        int a = in(), b = in();\n        g.add_edge(a, b);\n    }\n\
  ...
  verifiedWith: []
documentation_of: verify/library_checker/graph/tree/jump_on_tree.test.cpp
layout: document
redirect_from:
- /verify/verify/library_checker/graph/tree/jump_on_tree.test.cpp
- /verify/verify/library_checker/graph/tree/jump_on_tree.test.cpp.html

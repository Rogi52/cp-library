...
data:
  ...
  bundledCode: "#line 1 \"verify/library_checker/graph/tree/lca.test.cpp\"\n#define\
    ...
    \ 5 \"verify/library_checker/graph/tree/lca.test.cpp\"\n\nint main() {\n    int\
    \ N = in(), Q = in();\n    tree_graph<int> g(N);\n    for(int i : rep(1, N)) {\n\
  ...
  verifiedWith: []
documentation_of: verify/library_checker/graph/tree/lca.test.cpp
layout: document
redirect_from:
- /verify/verify/library_checker/graph/tree/lca.test.cpp
- /verify/verify/library_checker/graph/tree/lca.test.cpp.html

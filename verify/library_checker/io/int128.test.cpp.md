...
data:
  ...
  bundledCode: "#line 1 \"verify/library_checker/io/int128.test.cpp\"\n#define PROBLEM\
    ...
    \ a[i] < a[j] || (a[i] == a[j] && i < j);\n    });\n    return ids;\n}\n#line\
    \ 4 \"verify/library_checker/io/int128.test.cpp\"\n\nint main() {\n    int T =\
    \ in();\n    for(int _ : rep(T)) {\n        i128 A = in(), B = in();\n       \
    \ print(A + B);\n    }\n    return 0;\n}\n"
  ...
  requiredBy: []
  timestamp: '2023-11-01 09:01:54+09:00'
  verificationStatus: TEST_WRONG_ANSWER
  verifiedWith: []
documentation_of: verify/library_checker/io/int128.test.cpp
layout: document
redirect_from:
- /verify/verify/library_checker/io/int128.test.cpp
- /verify/verify/library_checker/io/int128.test.cpp.html
